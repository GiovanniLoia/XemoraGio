...
#working directory 
working_dir = '/home/marchandlab/github/jay/xemora_randomer_troubleshooting/double_alignment_development/240503_BSAT_model_S3N'
...
'''
Added a parameter to turn off basecalling/sam file generation, file paths are needed in else current 
--Jayson
'''
...
if regenerate_basecall == True: 
    ...
    mod_pod_dir = '/home/marchandlab/github/jay/xemora_randomer_troubleshooting/double_alignment_development/240503_ST_model_building/modified/pod5' #path to modified merged pod5 directory, do not include /merged.pod5 
    can_pod_dir = '/home/marchandlab/github/jay/xemora_randomer_troubleshooting/double_alignment_development/240503_ST_model_building/canonical/pod5' #path to canonical merged pod5 directory, do not include /merged.pod5
    mod_aligned_path = '/home/marchandlab/github/jay/xemora_randomer_troubleshooting/double_alignment_development/240503_ST_model_building/modified/bam/bam_mm2.sam' #path to modified sam file 
    can_aligned_path = '/home/marchandlab/github/jay/xemora_randomer_troubleshooting/double_alignment_development/240503_ST_model_building/canonical/bam/bam_mm2.sam' #path to canonical sam file
...
if mod_base in ''.join(xna_base_pairs): 
    mod_ref_strings, mod_xna_pos = ref_xnapos_gen(os.path.join(ref_dir,'x'+os.path.basename(xna_ref_fasta)), df_mod['Reference Sequence Name'])
    can_ref_strings, can_xna_pos = ref_xnapos_gen(os.path.join(ref_dir,'x'+os.path.basename(dna_ref_fasta)), df_can['Reference Sequence Name'])
else: 
...
can_read_xna_pos = filter_by_strand(can_read_xna_pos_all, check_strand)
...
can_full_bed_path = generate_bed_file(can_read_xna_pos_all, ref_dir, can_base, standard_base_pairs)
...
#can_filter_sam, can_reads_fasta = sam_filter_fasta_gen(can_aligned_path, ref_dir, can_full_bed_path, 'can', can_bam_dir)
