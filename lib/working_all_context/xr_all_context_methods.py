...
def preprocessing_reads(raw_data_file, ref_fasta, dataset_type, raw_dir, pod_dir, fastq_dir, bam_dir, ref_dir): #dataset_type means modified or not, really bad variable name lol 
    """
...
def generate_bed_file(xna_position_info, reference_directory, chunk_label, chunk_range, chunk_shift):
    """
